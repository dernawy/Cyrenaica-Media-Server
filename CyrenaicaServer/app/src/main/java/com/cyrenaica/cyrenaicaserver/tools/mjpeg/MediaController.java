...
public class MediaController extends FrameLayout {
    ...
    private void updateFloatingWindowLayout() {
        ...
        // within its space
        mDecor.measure(View.MeasureSpec.makeMeasureSpec(mAnchor.getWidth(), View.MeasureSpec.AT_MOST), View.MeasureSpec.makeMeasureSpec(mAnchor.getHeight(), View.MeasureSpec.AT_MOST));
