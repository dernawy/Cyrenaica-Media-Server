...
public class VideoEncoder {
    ...
    public VideoEncoder(Context context, Surface s) {
        pContext = context;
        mSurface = s;
    }
    ...
    private void prepareEncoder() throws IOException {
        ...
        try {
            mMuxer = new MediaMuxer(Objects.requireNonNull(getVideoSaveInternalStoragePath()), MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4);
