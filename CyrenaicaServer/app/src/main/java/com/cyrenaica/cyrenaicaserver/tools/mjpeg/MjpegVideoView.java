...
import com.cyrenaica.cyrenaicaserver.tools.mjpeg.PolicyCompat;
import java.io.IOException;
import java.util.Map;

public class MjpegVideoView extends SurfaceView implements MediaController.MediaPlayerControl{
    ...
    public MjpegVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initVideoView();
    }

    public MjpegVideoView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        else
        {
            ...
            Log.i(TAG, "no size yet, just adopt the given spec sizes");
        }
    ...
    public CharSequence getAccessibilityClassName() {
        return MjpegVideoView.class.getName();
    }
    ...
    private final MediaPlayer.OnErrorListener mErrorListener = new MediaPlayer.OnErrorListener() {
        ...
        public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
            ...
            if (getWindowToken() != null) {
                ...
                new AlertDialog.Builder(getContext()).setMessage(messageId).setPositiveButton("ERROR" /*R.string.VideoView_error_button*/, new DialogInterface.OnClickListener() {
